...
Если запускать интегральные тесты внутри контейнера,
то надо выполнить команду для запуска локального сервера внутри него.
Это нужно, чтобы апи тесты обращались через локалхост к апи.
